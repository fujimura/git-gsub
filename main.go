...
func (cli *CLI) Run(_args []string) int {
	...
	var screamingSnake = flag.Bool("screaming-snake", false, "Substitute screaming-snake-cased expressions")
	...
	if *screamingSnake {
		addSub(&substitutions, rawFrom, to, strcase.ToScreamingSnake)
	}
